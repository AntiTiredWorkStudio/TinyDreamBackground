<?php
    ...
    [
        ...
        'pay'=>R('PlaceOrderInADreamPoolPay',['uid','oid','bill','pcount','action','#did']),//支付完成【修改action】
        'oinfo'=>R('GetAllOrdersUser',['uid','#seek','#count']),//获取玩家的全部订单
        ...
        'plistg'=>R('GetPoolsInfoByRange',['uid','min','max','#type']),//用户获取全部梦想池信息及参与信息,可选参数type(RUNNING,FINISHED,JOIN)
        ...
        'wxpayweb'=>R('WxPayWeb',['oid','bill','uid','#bodyinfo']),//统一下单公众号
        'plistr'=>R('GetRunningPoolInfoByRange',['seek','count','#redpack']),//用户获取进行中的梦想池
		...
		'oitc'=>R('GetOrderCountByTeleORDate',['#tele','#date','#datemax']),//根据电话或日期获取订单数量
		'oitd'=>R('GetOrdersByTeleORDate',['seek','count','#tele','#date','#datemax']),//根据电话或日期获取范围订单
